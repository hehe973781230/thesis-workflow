...
| **v2.x**（新框架） | `thesis-workflow-v2` | **v2.0.8-beta** | ⚠️ 测试版，multi-search并行引擎 + RuntimeLLM | [CHANGELOG-v2.md](./CHANGELOG-v2.md) |

### 选型指南

- **生产环境 / 已有 v1 用户** → `thesis-workflow` (v1.7.3，稳定)
- **新框架 / outline-anchored / 9 HIL 体验** → `thesis-workflow-v2` (v2.0.8-beta，测试)
- **同时跑多篇论文** → 两个都装，**可共存**
